...
print(colour_yellow +"boomcpu.py Random Bitcoin&Litecoin Legacy compressed/uncompresses address and Segwit address P2SH.Bitcoin Gold\BitcoinCash\Zcash\Doge\DASH\ETH\ZEN\ZEIT\TENT List loading Good Luck..." + colour_reset)
...
print(colour_cyan + "\nboomcpu.py---" + colour_red + "---------mizogg.co.uk---------" + colour_cyan + "---boomcpu.py"  + colour_reset)
